...
class Blog(db.Model):
  ...
  images: Mapped[list["BlogImage"]] = relationship("BlogImage", back_populates="blog", cascade="all, delete-orphan", order_by="BlogImage.order_index")
  paragraphs: Mapped[list["BlogParagraph"]] = relationship("BlogParagraph", back_populates="blog", cascade="all, delete-orphan", order_by="BlogParagraph.order_index")
